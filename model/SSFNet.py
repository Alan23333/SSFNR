...
#### Spectral Enhanceme
class SE(nn.Module):
    def __init__(self, num_feat, compress_ratio=4, squeeze_factor=16, memory_blocks=128):
...
class SFB(nn.Module):
    def __init__(self, dim, reso, num_heads,
        ...
        self.mlp = DGFN(in_features=dim, hidden_features=mlp_hidden_dim, out_features=dim, act_layer=act_layer,
                       drop=drop)
        ...
        self.f_domain = FrequencyDomain(in_channels=dim-self.channels)
    ...
    def forward(self, x, x_size):
        ...
        attened = rearrange(attened, 'b n (g d) -> b n ( d g)', g=2)
